...
- **Sampling**: {strategy, estimated event volume and cost evidence; production `always_on`
...
- [ ] Production sampling is justified with estimated event volume and cost evidence; `always_on`
      has explicit user approval; required noisy endpoints are suppressed.
